...
export const FIELDS_LOG_TABLE = 'fields'
...
export const FIELDS_SIGNALS_LOG_TABLE = 'fields_signals'
export const SECTORS_SIGNALS_LOG_TABLE = 'sectors_signals'
export const THESES_SIGNALS_LOG_TABLE = 'theses_signals'
