...
INSERT INTO public.theses_in_sectors (thesis_id, sector_id, valid_from, weight) 
VALUES (1, 1, EXTRACT(EPOCH FROM TIMESTAMP '2025-01-20 7:00:00'), NULL),
(2, 2, EXTRACT(EPOCH FROM TIMESTAMP '2025-01-20 7:00:00'), 1),
(3, 2, EXTRACT(EPOCH FROM TIMESTAMP '2025-01-20 7:00:00'), NULL),
(4, 3, EXTRACT(EPOCH FROM TIMESTAMP '2025-01-20 7:00:00'), NULL),
(5, 4, EXTRACT(EPOCH FROM TIMESTAMP '2025-01-20 7:00:00'), NULL);
