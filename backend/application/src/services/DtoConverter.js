...
class DtoConverter {
    ...
    convertOptimalStateWrapper(results) {
        ...
        return new OptimalStateData(results[0].thesisName, results[0].optimalProfileId, results[0].binningId, results[0].validFrom, results[0].validTo, results[0].stopPercentage, results[0].optimalDryBound, results[0].optimalWetBound, optimalProfile)
    }
